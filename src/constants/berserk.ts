...
const CHAPTER_PICTURES = map(range(0, CHAPTERS_TOTAL), () => null);

const CHAPTER_PICTURES_FLAT = CHAPTER_PICTURES;
...
const SEASON_COVERS = ['Berserk_Anime_Box_Art'] as const;
...
const CHAPTERS_PER_EPISODE = [
    2, 3, 3, 4, 2, 4, 2, 1, 3, 3, 3, 5, 3, 3, 3, 6, 3, 3, 6, 3, 7, 9, 4, 6, 10,
] as const;
...
const EPISODE_OFFSETS: Tuple<Offset, 0> = [];

const SEASON_OFFSETS: Tuple<Offset, 0> = [];
...
const SEASON_TITLES = ['Berserk (1997 Anime)'] as const;
